...
export const ONBOARDING_STEPS: OnboardingStep[] = [
  ...
  },
  {
    ...
    title: 'Add Color',
    body: 'Tap any variation to hear that flavor—try a 7th or sus4.',
    primaryButton: 'Got it',
    showSkip: true,
    advanceTrigger: 'button',
    tooltipPosition: 'bottom',
  ...
  {
    id: 'combining-variations',
    target: '.chord-card-modifiers',
    title: 'Combine Variations',
    body: 'Long-press to lock variations and combine them—like 7 + sus4 for a jazzy sound.',
    primaryButton: 'Got it',
    showSkip: true,
    advanceTrigger: 'button',
    tooltipPosition: 'bottom',
